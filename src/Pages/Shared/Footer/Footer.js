...
<div> 
    ...
    <Link to='/terms & condition' className='text-white  font-semibold'>Terms & Condition</Link>
</div> 
<div>
  <span className="text-xl font-bold text-white">Flow Us</span> 
  <div className='grid grid-flow-col gap-8 mt-6'>
