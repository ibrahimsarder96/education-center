...
const LearningPlatFrom = () => {
  ...
  return (
    <div>
      <section className='header grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 lg:gap-16 gap-4 mb-16 mt-16'>
      <div>
       ...
       <div className='icon flex items-center'>
        ...
        <p className='text-xl text-gray-500 lg:ml-5'>9/10 Average Satisfaction Rate</p>
       </div>
       <div className='icon flex items-center my-4'>
        <span className=' text-green-500'> <ImCheckboxChecked></ImCheckboxChecked></span>
        <p className='text-xl text-gray-500 lg:ml-5'>96% Completitation Rate</p>
       </div>
       <div className='icon flex items-center'>
        <span className=' text-green-500'>< ImCheckboxChecked></ImCheckboxChecked></span>
        <p className='text-xl text-gray-500 lg:ml-5'>Friendly Environment & Expert Teacher</p>
       </div>
