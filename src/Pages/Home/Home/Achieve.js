...
const Achieve = () => {
  return (
    <section className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 lg:gap-0 gap-4 mb-16 mt-16'>
      ...
      <div>
        <h5 className='text-green-400 font-bold text-xl'>About Edumim</h5>
        <h2 className='text-5xl font-bold my-5'>The Place Where You Can</h2>
        <div>
          <p className='text-4xl font-bold text-purple-600'>Achieve</p>
       ...
       <h3 className='text-2xl font-bold'>Our Vision</h3>
        ...
        <Link to='/'><button type="button" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 dark:focus:ring-gray-400 font-medium rounded-lg text-semibold px-8 py-5 text-center mr-2 mb-2 mt-10">Read more us</button></Link>
        </section>
      </div>
    </section>
  );
